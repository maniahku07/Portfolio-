                ...
                <div className="contact-content">
                    ...
                    <div className="contact-info">
                        ...
                        >
                            ...
                            <span className="contact-card-data">manish0704ku@gmail.com</span>
                            <a href="mailto: manish0704ku@gmail.com" target="_blank"  rel="noreferrer" className="contact-button">
                                Write me {" "}
                        ...
                        >
                            ...
                            <span className="contact-card-data">+91 9905815980</span>
                            <a href="https://wa.me/+919905815980" target="_blank"  rel="noreferrer" className="contact-button">
                                Write me {" "}
                                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                            </a>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="contact-card-data">_manish_ku07
                            </span>
                            <a href=""  rel="noreferrer" target="_blank" className="contact-button">
                                DM me {" "}
                                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                            </a>
                        </motion.div>
